...
GENERIC_DOMAINS = [
    ...
    'lnk.bio', 'stan.store', 'campsite.bio', 'tap.bio',
    'milkshake.app', 'shorby.com',
    # Encurtadores usados como site principal
    'bit.ly', 'cutt.ly',
]

def is_generic_site(url: str) -> bool:
    """Retorna True se a URL é um site genérico (rede social, linktree, etc.)"""
    if not url:
        return False
    try:
